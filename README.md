...
Local Rust MCP tools for large codebases: fast indexed search, symbol outlines, reference lookup, dependency analysis, module discovery, visual code atlas pages, and DeepWiki-style repository documentation.
